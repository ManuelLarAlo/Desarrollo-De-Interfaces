...
"       <a href='"+gsPath+"lonuevo/lo_nuevo0703.aspx'><acronym title='Lo Nuevo de este mes'>Lo Nuevo</acronym></a> -" +
...
if( mBanSegundos < 10 ) // 0-9 (10)
{
// Velneo 30/Nov/06
document.write(""+
"<div><center><a target='_blank' href='http://www.velneo.com/web/p.pro?p=32516'>"+
"<img style='border:0px;width:562;height:76' alt='Velneo' src='" + gsPath +"sponsors/velneo562x76.jpg'></a></center></div>"+
"");
}
else if( mBanSegundos < 15 ) // 10-14 (5)
{
// Anuncio Libro
document.write(""+
"<div align=center><h2><a href='" + gsPath + "NET/MIVB2005/comprar.asp'>Regalate mi libro de Visual Basic 2005</a></h2></div>");
}
else if( mBanSegundos < 25 ) // 15-24 (10)
// 15-19 (5)
{
// Búsqueda y foros
...
else if( mBanSegundos < 39 ) // 25-38 (14)
{
// Oferta foros a 4.95
...
"<b><font size='5'><font color='#FF0000'>OFERTA</font> de <a href='"+gsPath+"hostings/elguille_ofertas_hosting.asp'>alojamiento</a> .NET 2.0, SQL Server, 4.95 Eur al mes"+
"<br><font color='#008000'>Ahora con el doble de casi todo !!!</font></font></b><br>&nbsp;"+
"			</td>"+
"		</tr>"+
"	</table>"+
"</div>");
}
else if( mBanSegundos < 44 ) // 39-43 (5)
{
// Oferta foros a 2.95
document.write("<div align='center'>"+
...
"		<tr>"+
"			<td align='center' bgcolor='#F0F0F0'>&nbsp;<br>"+
"<b><font size='5'><font color='#FF0000'>La OFERTA</font> de <a href='"+gsPath+"hostings/elguille_ofertas_hosting.asp'>alojamiento</a> <font color='#FF0000'>m&aacute;s econ&oacute;mica</font>: 2.95 Eur"+
"<br><font color='#008000'>Ahora con el doble de casi todo !!!</font></font></b><br>&nbsp;"+
"			</td>"+
"		</tr>"+
"	</table>"+
...
else if( mBanSegundos < 50 ) // 44-49 (6)
{
// Microsoft 01/Ene/07 al 30/Jun/07 (banner espiral desde el 27/Feb)
document.write("<center>"+
"<a target='_blank' href='http://go.microsoft.com/?linkid=5075842'>"+
"<img src='"+gsPath+"sponsors/ms_espiral_300x250.gif' alt='Visual Studio 2005' border='0'></a>"+
"</center>");
...
"<center>"+
"<div id='flashcontent'>"+
" <embed src='"+gsPath+"sponsors/ms_espiral_468x60.swf' quality=high pluginspage='http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash' type='application/x-shockwave-flash' width='468' height='60' loop='false' scale='exactfit'></embed>"+
"</div><script type='text/javascript'>"+
"   var mymovie = new FlashObject('"+gsPath+"sponsors/ms_espiral_468x60.swf', 'pelicula', '468', '60', '7', '#ffffff');"+
...
document.write("<center>"+
"<a target='_blank' href='http://go.microsoft.com/?linkid=5075842'>"+
"<img src='"+gsPath+"sponsors/ms_espiral_468x60.gif' alt='Visual Studio 2005' border='0'></a>"+
"</center>");
}